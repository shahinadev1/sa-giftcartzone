      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to US Virtual Shop, Naogaon.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to US Virtual Shop, accessible from{" "}
            <a
              href="http://usvirtualshop.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://usvirtualshop.com/
            </a>
          </p>
        </li>
        <li>
