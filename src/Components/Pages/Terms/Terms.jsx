...
const Terms = () => {
  return (
    <div className="container mb-5 overflow-hidden">
      ...
      <p>Welcome to http://usvirtualshop.com/!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of US Virtual Shop's Website, located at http://usvirtualshop.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use http://usvirtualshop.com/ if you do
      ...
      <p>
        We employ the use of cookies. By accessing http://usvirtualshop.com/,
        you agreed to use cookies in agreement with the US Virtual Shop's
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, US Virtual Shop and/or its licensors own the
        intellectual property rights for all material on
        http://usvirtualshop.com/. All intellectual property rights are
        reserved. You may access this from http://usvirtualshop.com/ for your
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from http://usvirtualshop.com/</li>
        <li>
          Sell, rent or sub-license material from http://usvirtualshop.com/
        </li>
        <li>
          Reproduce, duplicate or copy material from http://usvirtualshop.com/
        </li>
        <li>Redistribute content from http://usvirtualshop.com/</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. US
        Virtual Shop does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of US Virtual Shop,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, US Virtual Shop
      ...
      <p>
        US Virtual Shop reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant US Virtual Shop a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of US Virtual Shop; and (d) the
      ...
      <p>
        ...
        e-mail to US Virtual Shop. Please include your name, your organization
      ...
      <p>
        No use of US Virtual Shop's logo or other artwork will be allowed for
